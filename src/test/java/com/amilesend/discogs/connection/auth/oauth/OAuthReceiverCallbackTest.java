...
public class OAuthReceiverCallbackTest {
    ...
    public void handle_withCodeReturned_shouldSetCode() {
        final HttpExchange mockHttpExchange = newMockHttpExchangeFor("oauth_verifier=CodeValue", "/Callback");
    ...
    @SneakyThrows
    @Test
    public void handle_withDeniedReturned_shouldSetError() {
        final HttpExchange mockHttpExchange = newMockHttpExchangeFor("denied=ErrorValue", "/Callback");
        callbackUnderTest.handle(mockHttpExchange);
        assertAll(
    ...
    public void handle_withNoErrorAndSuccessLandingPageUrl_shouldSetResponseHeaders() {
        ...
        final HttpExchange mockHttpExchange =
                newMockHttpExchangeFor("oauth_verifier=CodeValue", "/Callback", mockHeaders);
    ...
    public void handle_withErrorAndFailureLandingPageUrl_shouldSetResponseHeaders() {
        ...
        final Headers mockHeaders = mock(Headers.class);
        final HttpExchange mockHttpExchange =
                newMockHttpExchangeFor("denied=ErrorValue", "/Callback", mockHeaders);
