...
public class DiscogsConnectionTestBase {
    ...
    @Mock
    protected AuthVerifier mockAuthVerifier;
    protected DiscogsConnection connectionUnderTest;

    @BeforeEach
    public void setUp() {
        lenient().when(mockGsonFactory.getInstance(any(DiscogsConnection.class))).thenReturn(mockGson);
        connectionUnderTest = spy(DiscogsConnection.builder()
