...
public class GetUploadsResponse extends PaginatedResponseBase<GetUploadsResponse> {
    /**
     * The list of items.
     *
     * @see UploadItem
    ...
    @Override
    public Class<GetUploadsResponse> getType() {
        return GetUploadsResponse.class;
    }
