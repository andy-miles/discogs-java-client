...
public enum SleeveCondition {
    ...
    private static Map<String, SleeveCondition> VALUE_TO_ENUM = getValueToEnumMap();
    ...
    /**
     * Gets the {@code SleeveCondition} enum from the given value.
     *
     * @param value the value
     * @return the condition, or {@code null}
     */
    public static SleeveCondition fromValue(final String value) {
    ...
    private static Map<String, SleeveCondition> getValueToEnumMap() {
        return Arrays.stream(SleeveCondition.values())
                .collect(Collectors.toMap(SleeveCondition::getValue, (c) -> c));
    }
