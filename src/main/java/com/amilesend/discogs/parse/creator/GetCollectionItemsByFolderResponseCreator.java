 ...
 * resource type so that method operations can be performed on the {@link GetCollectionItemsByFolderResponse}
 * resource.
 *
 * @see InstanceCreator
...
public class GetCollectionItemsByFolderResponseCreator implements InstanceCreator<GetCollectionItemsByFolderResponse> {
    /**
    ...
    @Override
    public GetCollectionItemsByFolderResponse createInstance(final Type type) {
        return GetCollectionItemsByFolderResponse.builder().connection(connection).build();
    }
}
